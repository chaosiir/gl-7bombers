...
public class Bomberball extends Game {
	...
	public void render() {//une fois l'application lancée la fonction render tourne en boucle et va afficher une image sur l'écran à
		// chaque fin d'appel (appellée autant de fois qu'il y a d'images par seconde )
	 ...
	 */
	@Override
	public void dispose() {//quand la fenetre est fermée on lance cette fonction
		int i;
	...
	public static boolean copier(File source, File dest) {
		try {
			InputStream sourceFile = new java.io.FileInputStream(source);
