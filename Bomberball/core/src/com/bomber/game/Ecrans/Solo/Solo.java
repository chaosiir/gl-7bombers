...
public class Solo extends Etat implements Screen  {//etat multijoueur
     ...
     * @param bombaaaagh : L'application Bomberball globale. Un excellent jeu ;)
     ...
     * @return boolean : retourne true si l'événement n'est pas traité
     */
    @Override
    ...
    /**
     * Gère le comportement de tous les ennemis un par un, durant le tour des ennemis.
     */
