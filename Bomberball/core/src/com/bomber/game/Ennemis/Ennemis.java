...
public abstract class Ennemis extends Image {
    ...
    protected Case prochaine;//prochaine case sur laquelle l'ennemis doit aller
    ...
    protected Action animation;//animation actuelle de l'ennemis
    ...
    /**
     * change l'annimation de l'ennemis pourqu'il danse lorsque le joueur meurt
     */
    ...
    public void deplacer(){
        ...
        while(!prochain_deplacement.isEmpty() && i>0){//tant qu'il reste des déplacement ou des mouvement à faire
            ...
            if(prochaine.getEnnemi()!=null && prochaine.getEnnemi()!=this){//si il y a un ennemis on arrete le mouvement
                break;
            }
            else{
    ...
    /**
     * Vérifie si une case est vide donc qu'il n'y ait pas de mur ou d'autre ennemis
     * @param caseC
    ...
    public Action deplacementdroite(){
        ...
        seq.addAction(new Action() {//la premiere action
            @Override
        ...
        return seq;//on renvois la sequence des 3 actions
    ...
    /**
     * renvois une action affichant un deplacement vers le haut de l'ennemis
     * @return Action
     */
