...
public class Map extends Group {//meme chose map est un group d'acteur (les cases)
    ...
    public int tailleX() {
        return x;
    }//!!!!!!!!!!!!!!!!!!!!!!!  le get/set X ou Y sont interdit car sont des fonctions pour l'affichage !!!!!!!!!!!
    ...
    public Map generatePve(int nbDestru, int nbInDestru, int bonus) {
        ...
        while (cpt > 0) {
            ...
            if (grille[x][y].getMur() == null && cpt == 1 && grille[x][y].getPorte() == null) {
                ...
                try {
                    if (Bomberball.parametreSolo.getNbBombeT().getText().parseInt()!=-1){
                        grille[x][y].getPersonnage().setNbBombe(Bomberball.parametreSolo.getNbBombeT().getText().parseInt());
                    }
                }catch(NumberFormatException e){}
                try {
                    if (Bomberball.parametreSolo.getNbDeplaJoueurT().getText().parseInt()!=-1){
                        grille[x][y].getPersonnage().setNbBombe(Bomberball.parametreSolo.getNbDeplaJoueurT().getText().parseInt());
                    }
                }catch(NumberFormatException e){}
                try {
                    if (Bomberball.parametreSolo.getPorteeBombeT().getText().parseInt()!=-1){
                        grille[x][y].getPersonnage().setNbBombe(Bomberball.parametreSolo.getPorteeBombeT().getText().parseInt());
                    }
                }catch(NumberFormatException e){}
                cpt--;
            }
        ...
        m.getGrille()[1][1].setEnnemi(new EnnemiPassif(true, m.getGrille()[1][1], 2));
        int i;
        int j;
        for (i = 0; i < m.tailleX(); i++) {
            for (j = 0; j < m.tailleY(); j++) {
        ...
        while (scan.hasNext()) {
            ...
            switch (choix) {
                ...
                case 1:
                    ...
                    g[x][y].setposX(x);
                    g[x][y].setposY(y);
                    g[x][y].setMur(new MurD());
                    break;
                case 2:
                    g[x][y] = new Case();
                    g[x][y].setposX(x);
                    g[x][y].setposY(y);
                    g[x][y].setMur(new MurI());
                    break;
                case 3:
                    g[x][y] = new Case();
                    g[x][y].setposX(x);
                ...
                case 4:
                    ...
                    g[x][y].setposX(x);
                    g[x][y].setposY(y);
                    g[x][y].setPorte(new Porte());
                    break;
                case 5:
                    g[x][y] = new Case();
                    g[x][y].setposX(x);
                    g[x][y].setposY(y);
                    g[x][y].setBonus(new BonusBombe(g[x][y]));
                    g[x][y].setMur(new MurD());
                    break;
                case 6:
                    g[x][y] = new Case();
                    g[x][y].setposX(x);
                    g[x][y].setposY(y);
                    g[x][y].setBonus(new BonusExplo(g[x][y]));
                    g[x][y].setMur(new MurD());
                    break;
                case 7:
                    g[x][y] = new Case();
                    g[x][y].setposX(x);
                    g[x][y].setposY(y);
                    g[x][y].setBonus(new BonusMove(g[x][y]));
                    g[x][y].setMur(new MurD());
                    break;
                case 8:
                    g[x][y] = new Case();
                    g[x][y].setposX(x);
                    g[x][y].setposY(y);
                    g[x][y].setBonus(new BonusPousser(g[x][y]));
                    g[x][y].setMur(new MurD());
                    break;
                case 9:
                    g[x][y] = new Case();
