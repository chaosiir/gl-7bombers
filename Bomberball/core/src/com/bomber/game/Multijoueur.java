...
public class Multijoueur extends Etat implements Screen {//etat multijoueur
    ...
    public void show() {
        ...
        joueur3.setPosition(jeu.map.getX()+jeu.map.tailleX(),Gdx.graphics.getHeight()-2*Bomberball.taillecase);
        ...
        mouvement3.setPosition(jeu.map.getX()+jeu.map.tailleX(),Gdx.graphics.getHeight()-3*Bomberball.taillecase);

        nbmvt3= new Label(""+personnage3.getPm(),skin);
        nbmvt3.setBounds(3*Bomberball.taillecase+30,Gdx.graphics.getHeight()-2*Bomberball.taillecase-50,nbmvt3.getWidth(),nbmvt3.getHeight()); //Positionnement à la main
        ...
        bombe3.setPosition(jeu.map.getX()+jeu.map.tailleX(),Gdx.graphics.getHeight()- 4*Bomberball.taillecase);

        nbBombe3= new Label(""+personnage3.getNbBombe(),skin);
        nbBombe3.setBounds(Bomberball.taillecase*3+30,Gdx.graphics.getHeight()-3*Bomberball.taillecase-60,nbBombe3.getWidth(),nbBombe3.getHeight()); //Positionnement à la main
        ...
        explosion3.setPosition(jeu.map.getX()+jeu.map.tailleX(),Gdx.graphics.getHeight()-5*Bomberball.taillecase);

        porteExplo3 = new Label(""+personnage3.getTaille(),skin);
        porteExplo3.setBounds(Bomberball.taillecase*3+30,Gdx.graphics.getHeight()-4*Bomberball.taillecase-60,porteExplo1.getWidth(),porteExplo1.getHeight()); //Positionnement à la main
        ...
        pousse3.setPosition(jeu.map.getX()+jeu.map.tailleX(),Gdx.graphics.getHeight()-12*Bomberball.taillecase);

        player3=new Image(Bomberball.multiTexture[21]);
        player3.setBounds(jeu.map.getX()+jeu.map.tailleX()+3*Bomberball.taillecase+30,Gdx.graphics.getHeight()-7*Bomberball.taillecase-50,Bomberball.taillecase,Bomberball.taillecase);
        ...
        joueur4.setHeight(Bomberball.taillecase);
        joueur4.setPosition(jeu.map.getX()+jeu.map.tailleX(),Gdx.graphics.getHeight()-8*Bomberball.taillecase);
        ...
        mouvement4.setPosition(jeu.map.getX()+jeu.map.tailleX(),Gdx.graphics.getHeight()-9*Bomberball.taillecase);

        nbmvt4= new Label(""+personnage4.getPm(),skin);
        nbmvt4.setBounds(3*Bomberball.taillecase+30,Gdx.graphics.getHeight()-8*Bomberball.taillecase-50,nbmvt3.getWidth(),nbmvt3.getHeight()); //Positionnement à la main
        ...
        bombe4.setPosition(jeu.map.getX()+jeu.map.tailleX(),Gdx.graphics.getHeight()- 10*Bomberball.taillecase);

        nbBombe4= new Label(""+personnage4.getNbBombe(),skin);
        nbBombe4.setBounds(Bomberball.taillecase*3+30,Gdx.graphics.getHeight()-9*Bomberball.taillecase-60,nbBombe3.getWidth(),nbBombe3.getHeight()); //Positionnement à la main
        ...
        explosion4.setPosition(jeu.map.getX()+jeu.map.tailleX(),Gdx.graphics.getHeight()-11*Bomberball.taillecase);

        porteExplo3 = new Label(""+personnage4.getTaille(),skin);
        porteExplo3.setBounds(Bomberball.taillecase*3+30,Gdx.graphics.getHeight()-10*Bomberball.taillecase-60,porteExplo1.getWidth(),porteExplo1.getHeight()); //Positionnement à la main
        ...
        pousse4.setPosition(jeu.map.getX()+jeu.map.tailleX(),Gdx.graphics.getHeight()-12*Bomberball.taillecase);

        player4=new Image(Bomberball.multiTexture[22]);
        player4.setBounds(jeu.map.getX()+jeu.map.tailleX()+3*Bomberball.taillecase+30,Gdx.graphics.getHeight()-7*Bomberball.taillecase-50,Bomberball.taillecase,Bomberball.taillecase);
