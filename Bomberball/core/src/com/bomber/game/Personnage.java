    ...
    public boolean deplacerHaut(){
        ...
        if(this.caseVideHaut()){
            ...
            if (c.getBombe()!=null){
                ...
                c.getMap().getGrille()[c.posX()][c.posY()+i].setBombe(this.taille,this,c.getMap().getGrille()[c.posX()][c.posY()+i])
            }
    ...
    public boolean deplacerDroite(){
        ...
        if (c.getMap().getGrille()[c.posX()+1][c.posY()].getMur()==null &&
            ...
            if (c.getBombe()!=null){
                ...
                c.getMap().getGrille()[c.posX()+i][c.posY()].setBombe(this.taille,this,c.getMap().getGrille()[c.posX()+i][c.posY()])
            }
            if(c.getBonus()!=null){c.getBonus().action();}
            return true;
        }
